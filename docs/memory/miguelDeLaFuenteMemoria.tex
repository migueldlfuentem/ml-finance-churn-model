...
\begin{document}
	...
	Como trabajo futuro, se propone explorar técnicas de ensamblaje heterogéneo (Stacking) combinando las predicciones del MLP y CatBoost para intentar romper el "techo de cristal" del 0.84 AUC, así como incorporar técnicas de explicabilidad (SHAP values) para proporcionar a los gestores bancarios el "porqué" de cada riesgo de fuga detectado.
